...
public class NoteDBshoes extends SQLiteOpenHelper {
	//创建表的字段
	public static final String ID = "_id";// 数据库ID
	public static final String TABLE_NAME = "shoes";// 指定表名
	...
	public NoteDBshoes(Context context) {
		//notes.db加上后缀.db较为方便！！！！
		super(context, "shoes.db", null, 1);// super(context, name(库名), factory,version版本);
	}
