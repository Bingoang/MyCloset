...
public class SelectshoesActivity extends Activity implements OnClickListener {
	private Button s_delete, s_back;
	private ImageView s_img;
	private VideoView s_video;
	private TextView s_tv;
	private NoteDBshoes noteDB;// 数据库对象
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// System.out.println(getIntent().getIntExtra(NoteDBshoes.ID,
	...
	public boolean deleteFile() {
		String fileNameImage=Uri.parse(getIntent().getStringExtra(NoteDBshoes.PATH))+"";
		String fileNameVideo=Uri.parse(getIntent().getStringExtra(NoteDBshoes.VIDEO))+"";
	...
	public void deleteDate() {
		...
		dbWriter.delete(NoteDBshoes.TABLE_NAME,
				"_id=" + getIntent().getIntExtra(NoteDBshoes.ID, 0), null);
	}
