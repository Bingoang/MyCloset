...
public class SelectpantsActivity extends Activity implements OnClickListener {
	private Button s_delete, s_back;
	private ImageView s_img;
	private VideoView s_video;
	private TextView s_tv;
	private NoteDBpants noteDB;// 数据库对象
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// System.out.println(getIntent().getIntExtra(NoteDBpants.ID,
	...
	public boolean deleteFile() {
		String fileNameImage=Uri.parse(getIntent().getStringExtra(NoteDBpants.PATH))+"";
		String fileNameVideo=Uri.parse(getIntent().getStringExtra(NoteDBpants.VIDEO))+"";
	...
	public void deleteDate() {
		...
		dbWriter.delete(NoteDBpants.TABLE_NAME,
				"_id=" + getIntent().getIntExtra(NoteDBpants.ID, 0), null);
	}
